...
Table 5.2 shows the results of the signed rank tests, with p-values and estimates corresponding to the median difference in average cover value between the biosolids and control treatment levels. Interestingly, with the non-parametric analysis we find that there are no significant treatment effects for any of the species.
...
In terms of correlation between MWD and average cover value, the results shows that for many of the plant species of interest there is a negative correlation. This means that as the MWD increases, the average cover value decreases. This issue might be due to the fact that the growth of some species negatively affects the growth of some other species. This would explain why the boisolids treatment does not always significantly affect the plant species composition, and why the correlation between MWD and average cover value is negative for many of the species. We also note that for some other species there is a moderate to low positive correlation between MWD and average cover value.
