...
> S550: Great exploratory analysis.
...
> S550: What is the motivation behind the qqnorm plot? It might not be required for the model we are using.
qqnorm(soil$MWD)
qqline(soil$MWD)

> S550: What information does this plot give us? Perhaps a comment above it, to describe what the function does.
acf(soil)
